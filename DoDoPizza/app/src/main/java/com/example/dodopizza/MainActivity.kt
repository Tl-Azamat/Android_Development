...
class MainActivity : AppCompatActivity() {
    ...
    private fun getAllItems(): List<Item> {
        ...
        items.add(Item(8, "combo3", "Bavarian", "Spicy chorizo sausages, pickled cucumbers, red onions, tomatoes, mustard sauce, mozzarella, signature tomato sauce", "1600 тг", true))
